...
#### SPEC-PLM-006: Change Order (25% remaining)
...
| ID | 기능 | 우선순위 | 예상 작업량 |
|----|------|----------|-------------|
| C-005 | ChangeOrderChart 실제 데이터 연결 | P1 | 1h |
...
| ID | 기능 | 우선순위 | 예상 작업량 |
|----|------|----------|-------------|
| D-001 | NotificationCenter 컴포넌트 | **P1** | 3h |
| D-002 | 알림 벨/배지 UI | **P1** | 1h |
| D-003 | 알림 클릭 시 해당 페이지 이동 | **P1** | 2h |
...
| ID | 기능 | 우선순위 | 예상 작업량 |
|----|------|----------|-------------|
| D-007 | DocumentRepository 페이지/컴포넌트 | **P1** | 4h |
| D-008 | 파일 업로드 Drag & Drop | **P2** | 2h |
| D-009 | 파일 크기/타입 검증 (50MB 제한) | **P1** | 2h |
